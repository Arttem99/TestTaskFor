<?
require_once "clases/Connect_DB.php";
require_once "clases/Registration.php";
require_once "clases/UsersDao.php";
...
<head>
    ...
    <div class="data-user">
        ...
        <div class="authorization div_field">
            <form>
                <div class="block_auth"><span>Login: </span> <input type="text" placeholder="Login" id="login-auth"></div>
            ...
            <form>
                ...
                <div class="block_conf_pass"><span>Confirm password: </span> <input type="password" placeholder="Password" id="comf_pass"><span id="err_confpass" class="error"></span></div>
                <div class="block_email"><span>Email: </span> <input type="email" placeholder="Email" id="email"><span id="err_email" class="error"></span></div>
                <div class="block_name"><span>Your Name: </span> <input type="text" placeholder="Name" id="name_user"><span id="err_user" class="error"></span></div>
